	...
	return (
		<main className='w-screen h-1/2'>
			<div className='absolute inset-0 w-full h-1/2 bg-stone-900 shadow-lg'>
				...
				<div className="absolute top-[5%] left-[2%] lg:left-[10%] group">
					...
					<button className='relative px-7 py-4 bg-black rounded-lg leading-none flex items-center divide-x divide-stone-600'>
						<span className="flex items-center space-x-5">
							<svg xmlns="http://www.w3.org/2000/svg" clasNames="h-8 w-8 text-pink-600 -rotate-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
								<path strokeLinecap="round" strokeLinejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
							</svg>
							<span className='text-stone-100 pr-6 text-2xl lg:text-5xl'>{title}</span>
						</span>
