...
const Landing = () => {
	return (
		<main className='absolute inset-0 bg-gray-900 w-screen h-[30%] md:h-[80%]'>
			<h3 className='relative mt-12 ml-12 text-white text-lg md:text-4xl'>
				saragray.dev
			</h3>
			<div className='absolute top-0 right-0 w-[30%] md:w-[60%] h-full'>
